...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.6-alpha.2` (2026-09-18 को सत्यापित: दोहरा typecheck + 286 टेस्ट; client peers `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0`)। इस लाइन पर `SessionListState.current` हटा दिया गया है — वर्तमान सत्र retention तथ्यों से निकाला जाता है, इसलिए इतिहास इंजेक्शन और स्निपेट लाइब्रेरी काम करते रहते हैं। |
| Node | `^22.19.0 \|\| >=24.0.0` |
